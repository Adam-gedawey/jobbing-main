...
const Navbar = () => {
  ...
  return (
    <>
      <div className="relative bg-[#ffffff] z-50">
        <nav className="container mx-auto flex items-center justify-between p-5">
          <div>
            <Link to="/" className="text-blue-600 font-bold text-xl">
              Job<span className="text-[#1677cccb]">Bing</span>
            </Link>
          </div>

          <ul className="hidden lg:flex gap-10 text-indigo-400	">
            <li>
            ...
            <Link 
              ...
              >
              {user?.accountType === "seeker"?
              "Applications": "Upload Job"}</Link>            </li>
            <li>
