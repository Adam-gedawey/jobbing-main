...
const UploadJob = () => {
  ...
  return (
    <div className="container-fluied mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-[#bbbbbb] px-5">
      <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-[#cccccc] px-5 py-10 md:px-10 shadow-md">
        <div>
