...
const About = () => {
  return (
    <div className="container-fluied mx-auto flex flex-col gap-8 2xl:gap-14 py-6 bg-gradient-to-r from-blue-700 to-sky-700">
      <div className="w-full flex flex-col-reverse md:flex-row gap-10 items-center p-5">
        <div className="w-full md:2/3 2xl:w-2/4">
          <h1 className="text-3xl text-white font-bold mb-5">About Us</h1>
      ...
      <div className="leading-8 px-5 text-justify text-white">
        <p>
          Microsoft Corporation and its contributors are available at
          http://www.microsoft.com and at http://www.microsoft.com for more
          information about the contributors and contributors to the Microsoft
