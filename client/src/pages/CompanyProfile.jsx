    ...
    <>
      <Transition appear show={open ?? false} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto bg-white bg-opacity-25">
            <div className="flex min-h-full items-center justify-center p-4 text-center bg-white">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
...
console.log(info)
  ...
  return (
    <div className="container-fluied mx-auto p-5 bg-[#dddddd]">
      <div className="">
